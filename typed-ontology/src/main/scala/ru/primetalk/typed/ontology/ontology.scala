...
import ru.primetalk.typed.ontology.meta.metameta.{SchemaBuilder, MetaSeq, Record}
import ru.primetalk.typed.ontology.meta.SimplePropertiesMeta.property
...
object ontology {
  ...
  val rtti = {
    import meta.SimplePropertiesMeta.TypeTagRtti._
